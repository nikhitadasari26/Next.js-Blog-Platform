...
export default function BlogPage({ posts, currentPage, totalPages }) {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            <Head>
                {generateNextSeo({
                    title: `Blog - Page ${currentPage} - Next.js Blog Platform`,
                    description: `Read our latest articles. Page ${currentPage}.`,
                    noindex: true
                })}
            </Head>
            <main className="container mx-auto px-4 py-8">
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 text-center">Blog (Page {currentPage})</h1>
...
export async function getStaticPaths() {
    ...
    // Start from page 2, as page 1 is served by /index.js
